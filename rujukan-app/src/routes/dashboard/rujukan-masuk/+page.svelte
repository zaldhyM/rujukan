  ...
  let referrals = $state([
    {
      ...
      notes:
        "Pasien mengalami nyeri perut kanan bawah sejak 2 hari yang lalu. Skala nyeri 7/10. Hasil lab leukositosis 15.000. Mohon tindakan operasi appendectomy segera.",
    },
    {
      id: "REF-007",
      patient: "Siti Rahma",
      ...
      notes:
        "Pasien sesak napas saat istirahat, edema pada tungkai bawah bilateral. Hasil rontgen kardiomegali dengan edema paru. Butuh ICU/ICCU segera.",
    },
    {
      id: "REF-006",
      ...
      notes:
        "GDS terakhir 450 mg/dL dengan ulkus diabetikum derajat III pada pedis dextra. Perlu debridement jaringan mati dan regulasi insulin.",
    },
    {
      id: "REF-005",
      ...
      notes:
        "Nyeri epigastrium berat disertai mual muntah berulang. Terapi standar rawat jalan kurang responsif. Rujuk ke poli penyakit dalam.",
      rejectReason:
        "Kapasitas poli penyakit dalam penuh untuk 3 hari ke depan. Disarankan rujuk ke RS tipe C terdekat.",
    },
    {
      id: "REF-004",
      ...
      notes:
        "Visus VOD 1/60, VOS 6/60. Kekeruhan lensa grade IV. Rujuk untuk tindakan bedah phacoemulsification.",
    },
  ]);
    ...
    referrals = referrals.map((ref) => {
      if (ref.id === referralToReject.id) {
        return {
          ...ref,
          status: "Rejected",
          rejectReason: rejectionReasonText,
        };
      }
      return ref;
    });
...
<div class="rujukan-masuk-container animate-fade-in">
  <div class="page-header">
    <div class="header-left">
      ...
      <h1>Rujukan Masuk</h1>
      <p class="subtitle">
        Kelola dan review rujukan pasien dari fasilitas kesehatan tingkat
        pertama (FKTP) atau RS lain
      </p>
    </div>
  </div>
  ...
  <div class="glass-panel filter-panel">
    ...
    <div class="filter-tabs">
      ...
      >
        Menunggu Review
        <span class="tab-badge bg-warning"
          >{referrals.filter((r) => r.status === "Pending").length}</span
        >
      </button>
      <button
        class="tab-btn"
...
{#if showDetailModal && selectedReferral}
  <div class="modal-backdrop" onclick={() => (showDetailModal = false)}>
    <div
      class="modal-content glass-panel animate-fade-in"
          ...
          <div class="info-section">
            ...
            <div class="info-grid">
              <div class="info-item">
                ...
                <span class="info-val text-white font-title"
                  >{selectedReferral.patient}</span
                >
              </div>
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span class="info-val"
                  >{selectedReferral.gender} / {selectedReferral.age}</span
                >
              </div>
              <div class="info-item">
          ...
          <div class="info-section">
            ...
            <div class="info-grid">
              <div class="info-item">
                ...
                <span class="info-val text-white font-title"
                  >{selectedReferral.diagnosis}</span
                >
              </div>
              <div class="info-item">
        ...
        <div class="footer-right">
          ...
          {#if selectedReferral.status === "Pending"}
            <button
              ...
              onclick={() => {
                openRejectModal(selectedReferral);
                showDetailModal = false;
              }}>Tolak Rujukan</button
            >
            <button
              class="btn btn-success"
              onclick={() => {
                approveReferral(selectedReferral.id);
                showDetailModal = false;
              }}>Terima Rujukan</button
            >
          {/if}
        </div>
      </div>
...
{#if showRejectReasonModal && referralToReject}
  <div class="modal-backdrop" onclick={() => (showRejectReasonModal = false)}>
    <div
      class="modal-content sub-modal glass-panel animate-fade-in"
      onclick={(e) => e.stopPropagation()}
    >
      <div class="modal-header">
        ...
        <button
          class="close-modal-btn"
          onclick={() => (showRejectReasonModal = false)}>&times;</button
        >
      </div>
      <div class="modal-body">
        <p class="text-secondary mb-3">
          Tentukan alasan mengapa rujukan untuk pasien <strong
            >{referralToReject.patient}</strong
          > ditolak.
        </p>
      ...
      <div class="modal-footer">
        <button
          class="btn btn-secondary"
          onclick={() => (showRejectReasonModal = false)}>Batal</button
        >
        <button
          class="btn btn-danger"
